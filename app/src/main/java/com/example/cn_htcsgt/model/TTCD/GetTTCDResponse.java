package com.example.cn_htcsgt.model.TTCD;

import com.example.cn_htcsgt.model.BaseResponse;

import java.util.ArrayList;

public class GetTTCDResponse extends BaseResponse {
    public ArrayList<GetTTCDResponse.Data> data;
    public class Data{
        public String id;
        ...
        public boolean SeachText(String text){
            ...
            if(SearchText == null || SearchText.isEmpty())SearchText = convert(soDinhDanh).toUpperCase();
